...
<head lang="de">
    <title>Datenschutz | Seen in Oldenburg</title>
    <meta charset="utf-8">
    ...
    <section>
        <div class="container my-5">
            <h1 class="h1-dark border-bottom-red center">Datenschutzerklärung</h1>
            ...
            <p><span class="tsmcontroller">Max Muster<br>
                Musterweg 1<br>
                12345 Musterstadt<br>
                E-Mailadresse: <a href='mailto:max@muster.de' target="_blank">max@muster.de</a><br>
                Link zum Impressum: <a href="imprint.php" >Impressum</a> <br>
                </span></p>
            ...
            <p>Als „Cookies“ werden kleine Dateien bezeichnet, die auf Rechnern der Nutzer gespeichert werden. Innerhalb
                ...
                kann bei einer Vielzahl der Dienste, vor allem im Fall des Trackings, über die US-amerikanische Seite <a
                        href="http://www.aboutads.info/choices/" target="_blank">http://www.aboutads.info/choices/</a> oder die EU-Seite
                <a href="http://www.youronlinechoices.com/" target="_blank">http://www.youronlinechoices.com/</a> erklärt werden. Des
            ...
            <br> Des Weiteren behalten wir uns vor, auf Grundlage unserer berechtigten Interessen gem. Art. 6 Abs. 1 lit. f. DSGVO, die Angaben der Nutzer zwecks Spamerkennung zu verarbeiten.<br>
            <br> Auf derselben Rechtsgrundlage behalten wir uns vor, im Fall von Umfragen die IP-Adressen der Nutzer für deren Dauer zu speichern und Cookies zu verwenden, um Mehrfachabstimmungen zu vermeiden.<br>
            <br> Die im Rahmen der Kommentare und Beiträge mitgeteilte Informationen zur Person, etwaige Kontakt- sowie Websiteinformationen als auch die inhaltlichen Angaben, werden von uns bis zum Widerspruch der Nutzer dauerhaft gespeichert.</span>
            </p>
            <p></p>
